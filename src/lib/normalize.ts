...
// Více URL lze řešit později; teď jen helpery (ponecháme je, ale nejsou nutné)
...
// DŮLEŽITÉ: výchozí hodnota parametru → jde volat bez argumentu
